<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MSP01.Master" CodeBehind="Agov.aspx.vb" Inherits="RAMA06.Agov" ValidateRequest="false" %>
    ...
    <asp:MultiView ID="multiview1" runat="server" ActiveViewIndex="0">
        <asp:View ID="viewshow" runat="server">
            <div class="container">
                ...
                <asp:HiddenField ID="hdfIDfound" runat="server" />
                ...
                <div class="form-inline" style="padding-bottom: 10px;">
                    ...
                    <asp:LinkButton ID="btnNew" runat="server" CssClass="btn btn-primary btn-lg">
                         <span class="glyphicon glyphicon-plus"></span> &nbsp;เพิ่มเรื่องทุน
                    </asp:LinkButton>

                </div>

                <div class="table-responsive">
                    <asp:GridView ID="gvData" DataKeyNames="IDfound" runat="server" CssClass="table table-bordered table-striped table-hover"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="วันที่ลงเรื่องทุน" DataField="datesend" DataFormatString="{0:MM/dd/yyyy}" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="200px">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
