...
#Region "EVEN"
            ...
            If mFunc.fCheckSession() Then
                ...
                If mDB.fReadDataTable(cmd, nDt) Then
                    If nDt.Rows.Count > 0 Then
                        hdrid.Value = nDt.Rows(0).Item("rID")
            ...
            If True Then
                If FileUpload4.HasFile Then
                    Try
                        ...
                        cmd.Parameters.AddWithValue("@rID", hdrid.Value)
    ...
    Protected Sub btnback_Click(sender As Object, e As EventArgs) Handles btnback.Click
        Response.Redirect("~/npage/Anew.aspx")
    End Sub
#End Region
...
#Region "FUNCTION"
    ...
    Private Sub BindGrid()
        ...
        Dim nDt As DataTable
        Dim strsql As String = "SELECT row_number() OVER (ORDER BY id_imgoss_New ASC) AS row,* FROM oss_imgnew  WHERE rID='" & hdrid.Value & "'"
    ...
    Private Function fUpdateData(ByRef pValue As String) As Boolean
        ...
        nSb.Append("update oss_new set ")
        nSb.Append("newHead = @newHead,newdetail = @newdetail,statusdate = @statusdate,datestart = @datestart,dateend = @dateend,statusicon = @statusicon,codestaff = @codestaff ")
        nSb.Append("where IDNew = @IDNew")
