<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MSP01.Master" CodeBehind="Editperson.aspx.vb" Inherits="RAMA06.Editperson" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <h2 align="center">แก้ไขข้อมูลส่วนตัว</h2>
            ...
            <div class="panel-body">
                ...
                <div class="text-center">
                    <asp:LinkButton ID="btnsave" runat="server" CssClass="btn btn-primary btn-lg">
                         <span class="glyphicon glyphicon-floppy-disk"></span> &nbsp;ยืนยันการแก้ไข
                    </asp:LinkButton>
                </div>
