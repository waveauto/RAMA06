                ...
                If nDt.Rows.Count > 0 Then
                    ...
                    Select Case typefile
                        ...
                        Case "slid"
                            ...
                            ScriptManager.RegisterStartupScript(Me, [GetType](), "showmodal", "$('#myModaltestslide').modal('show');", True)
    ...
    Private Sub rptObject_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles rptObject.ItemDataBound
        If (e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            If ItemActive <= ItemPerSlide Then
                ...
                sCarousel &= "<a href=""#""><img width=""800px"" ""height: 275px"" src=""http://10.6.22.114/RAMA06/RAMA06/" & mPath & Page.ResolveClientUrl(ImageName) & """ alt="""" /></a>" & vbCrLf
            ...
            Else
                ...
                sCarousel &= "<div class=""span3"">" & vbCrLf
                sCarousel &= "<div class=""thumbnail product-item"">" & vbCrLf
                'sCarousel &= "<a href=""#""><img width=""800px"" ""height: 275px"" src=""" & mPath & Page.ResolveUrl(ImageName) & """ alt="""" /></a>" & vbCrLf
                'sCarousel &= "<a href=""#""><img width=""800px"" ""height: 275px"" src=""" & mPath & ResolveUrl(ImageName) & """ alt="""" /></a>" & vbCrLf
