...
#Region "EVEN"
    ...
    Private Sub gvData_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvData.RowCommand
        ...
        If e.CommandName = "aEdit" Then
            ...
            Dim url As String = "10.6.22.114/06/npage/Vnew.aspx?value1=" + hdfid.Value
...
#Region "FUNCTION"
    Private Sub hidtab()
        If True Then
            Dim hiddenFieldValue As [String] = hidLastTab.Value
            Dim js As New StringBuilder()
            js.Append("<script type='text/javascript'>")
            js.Append("var previouslySelectedTab = ")
            js.Append(hiddenFieldValue)
            js.Append(";</script>")
            Page.ClientScript.RegisterClientScriptBlock(Me.[GetType](), "acttab", js.ToString())
