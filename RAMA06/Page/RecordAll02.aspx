<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MSPFirst.Master" CodeBehind="RecordAll02.aspx.vb" Inherits="RAMA06.RecordAll02" %>
...
<h1 class="text-center">
                    <a href="#" id="A2" runat="server" class="list-group-item">&nbsp;ขอเงินทุนสนับสนุนค่าตีพิมพ์</a></h1>
<br/>
<div class="text-left">  <asp:HyperLink ID="HyperLink1" runat="server" class="btn btn-info btn-lg" NavigateUrl="~/Page/FundingPublished.aspx" Width="200px"><span class="glyphicon glyphicon-edit"></span>ส่งขอเงิน...</asp:HyperLink>
