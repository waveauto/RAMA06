<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Committee02.aspx.vb" Inherits="RAMA06.Committee02" %>
...
<div class="container">  
    ...
    <hr />
    <div><h1>บันทึกผล พิจารณา ทุน โดย : รศ. จินตนันท์ ศรีสุยิ่ง</h1></div>
      <div class="panel panel-default">
                  <div class="panel-heading"> <strong> บันทึกผล การพิจารณาจริยธรรม (ทุน) </strong>
                      </div>
