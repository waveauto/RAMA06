<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MSP01.Master" CodeBehind="Reward.aspx.vb" Inherits="RAMA06.Reward" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <h1 class="text-left">การขอเงินรางวัล : </h1>
                    ...
                    <asp:MultiView ID="Multiview1" runat="server" ActiveViewIndex="0">
                        <asp:View ID="viewAllData" runat="server">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">ประเภทผลงานที่ตีพิมพ์ :</label>
                                    <div class="col-md-6">
                                        <div class="radio">
                                            <label>
                                                <asp:RadioButton ID="rdbT1" runat="server" GroupName="T" />Original Article</label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <asp:RadioButton ID="rdbT2" runat="server" GroupName="T" />Review Article</label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <asp:RadioButton ID="rdbT3" runat="server" GroupName="T" />Case Report</label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <asp:RadioButton ID="rdbT4" runat="server" GroupName="T" />Case Series</label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <asp:RadioButton ID="rdbT5" runat="server" GroupName="T" />Brief communication</label>
                                        </div>
