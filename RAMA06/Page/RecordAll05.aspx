<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MSPFirst.Master" CodeBehind="RecordAll05.aspx.vb" Inherits="RAMA06.RecordAll05" %>
...
<h1 class="text-center">
                    <a href="#" id="A2" runat="server" class="list-group-item">&nbsp;ขอแจ้งจดทรัพย์สินทางปัญญา (จดลิขสิทธิ์/สิทธิบัตร/อนุสิทธิบัตร)</a></h1>
<br/>
<div class="text-left">  <asp:HyperLink ID="HyperLink1" runat="server" class="btn btn-info btn-lg" NavigateUrl="~/Page/IntellectualProperty.aspx" Width="200px"><span class="glyphicon glyphicon-edit"></span>ส่งแจ้งจดทรัพย์...</asp:HyperLink>
