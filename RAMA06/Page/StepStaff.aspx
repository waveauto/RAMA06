<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="StepStaff.aspx.vb" Inherits="RAMA06.StepStaff" %>
...
<div> 
                   ...
                   <div> 
                          ...
                          <table class="nav-justified">
                              ...
                              <tr>
                                  ...
                                  <td rowspan="3">
                                      <asp:TextBox ID="TextBox1" runat="server" Height="80px" TextMode="MultiLine" Width="400px"></asp:TextBox>
                                      &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; 
                                  </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                               ...
                               <div class ="text-center" >
                                   <asp:Button ID="Button4"  class="btn btn-primary" runat="server" Text="แก้ไข" />
                                   <asp:Button ID="Button5"  class="btn btn-primary" runat="server" Text="บันทึก" />
                                   </div>
              ...
              <div class="panel-body">       
                   <div> 
                          <table class="nav-justified">
                              <tr>
                                  <td>นาย อภิเดช พรสังสีหากร</td>
                                  <td><strong>บันทึกสรุปผลการพิจารณา EC </strong></td>
                              </tr>
                              <tr>
                                  <td>หน่วยงาน โทร : 1025</td>
                                  <td rowspan="3">
                                      <asp:TextBox ID="TextBox4" runat="server" Height="80px" TextMode="MultiLine" Width="400px"></asp:TextBox>
                                      &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; 
                                  </td>
                              </tr>
                              <tr>
                  ...
                  <div class="panel-body">       
                      <div>
                          ...
                          <table class="nav-justified">
                              ...
                              <tr>
                                  <td>5</td>
                                  <td><strong>ดร.พญ.จิราภรณ์ สินเจริญ</strong></td>
                                  <td>ลบ</td>
                              </tr>
                          </table>
 ...
 <br />
                    ไฟล์แนบ (ถ้ามี)
       <div><asp:HyperLink ID="HyperLink47" runat="server"> เอกสาร XXXXXXXXXXXXXXXXXXXXXXX </asp:HyperLink></div> 
       <div><asp:HyperLink ID="HyperLink49" runat="server"> เอกสาร XXXXXXXXXXXXXXXXXXXXXXX </asp:HyperLink></div> 
       <div><asp:HyperLink ID="HyperLink48" runat="server"> เอกสาร XXXXXXXXXXXXXXXXXXXXXXX </asp:HyperLink></div> 
       <div><asp:HyperLink ID="HyperLink50" runat="server"> เอกสาร XXXXXXXXXXXXXXXXXXXXXXX </asp:HyperLink></div> 
       <div><strong>สถานะ :  
                                      ผ่าน</strong>
           </div>
              </div>
 ...
 <br />
                    ไฟล์แนบ (ถ้ามี)
       <div><asp:HyperLink ID="HyperLink2" runat="server"> เอกสาร XXXXXXXXXXXXXXXXXXXXXXX </asp:HyperLink></div> 
       <div><asp:HyperLink ID="HyperLink3" runat="server"> เอกสาร XXXXXXXXXXXXXXXXXXXXXXX </asp:HyperLink></div> 
       <div><asp:HyperLink ID="HyperLink4" runat="server"> เอกสาร XXXXXXXXXXXXXXXXXXXXXXX </asp:HyperLink></div> 
       <div><asp:HyperLink ID="HyperLink5" runat="server"> เอกสาร XXXXXXXXXXXXXXXXXXXXXXX </asp:HyperLink></div> 
       <div><strong>สถานะ : ไม่ผ่าน</strong>
           </div>
              </div>
           ...
           <div class="panel panel-default">
             <div class="panel-heading"><h4>2.2 : พิจารณา ทุนต่างๆ (ถ้ามี)</h4></div>
              <div class="panel-body">       
                   <div> 
                          ...
                          <table class="nav-justified">
                              <tr>
                                  <td>นาย อภิเดช พรสังสีหากร</td>
                                  <td><strong>บันทึกสรุปผลการพิจาณาทุน</strong></td>
                              </tr>
                              <tr>
                                  <td>หน่วยงาน โทร : 1025</td>
                                  <td rowspan="4">
                                      <asp:TextBox ID="TextBox5" runat="server" Height="80px" TextMode="MultiLine" Width="400px"></asp:TextBox>
                                      &nbsp;&nbsp; 
                                  </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                  <td>&nbsp;</td>
                                  <td>
                                   <asp:Button ID="Button8"  class="btn btn-primary" runat="server" Text="แก้ไข" />
                                   <asp:Button ID="Button9"  class="btn btn-primary" runat="server" Text="บันทึก" />
                                  </td>
                              </tr>
                          </table>
              ...
              <div class="panel-heading">กำหนดกรรมการพิจารณาทุน
                  <asp:Button ID="Button10"  class="btn btn-primary" runat="server" Text="เพิ่มกรรมการ" />
                  </div>
              <div class="panel-body">       
                  <div>
                      ...
                      <table class="nav-justified">
                          ...
                          <tr>
                              <td>1</td>
                              <td><strong>รศ. อภิชาต จันทนิสร์</strong></td>
                              <td>ลบ</td>
                          </tr>
                          <tr>
                              <td>2</td>
                              <td><strong>ศ.พจนันท์ ประทีปทอง</strong></td>
                              <td>ลบ</td>
                          </tr>
                          <tr>
                              <td>3</td>
                              <td><strong>ศ.เกรียงไกร พิพิธหิรัญการ</strong></td>
                              <td>ลบ</td>
                          </tr>
                          <tr>
                              <td>4</td>
 ...
 <br />
                    ไฟล์แนบ (ถ้ามี)
       <div><asp:HyperLink ID="HyperLink6" runat="server"> เอกสาร XXXXXXXXXXXXXXXXXXXXXXX </asp:HyperLink></div> 
       <div><asp:HyperLink ID="HyperLink8" runat="server"> เอกสาร XXXXXXXXXXXXXXXXXXXXXXX </asp:HyperLink></div> 
       <div><asp:HyperLink ID="HyperLink9" runat="server"> เอกสาร XXXXXXXXXXXXXXXXXXXXXXX </asp:HyperLink></div> 
       <div><asp:HyperLink ID="HyperLink10" runat="server"> เอกสาร XXXXXXXXXXXXXXXXXXXXXXX </asp:HyperLink></div> 
       <div><strong>สถานะ :  
                                      ผ่าน</strong>
           </div>
              </div>
 ...
 <br />
                    ไฟล์แนบ (ถ้ามี)
       <div><asp:HyperLink ID="HyperLink11" runat="server"> เอกสาร XXXXXXXXXXXXXXXXXXXXXXX </asp:HyperLink></div> 
       <div><asp:HyperLink ID="HyperLink12" runat="server"> เอกสาร XXXXXXXXXXXXXXXXXXXXXXX </asp:HyperLink></div> 
       <div><asp:HyperLink ID="HyperLink13" runat="server"> เอกสาร XXXXXXXXXXXXXXXXXXXXXXX </asp:HyperLink></div> 
       <div><asp:HyperLink ID="HyperLink14" runat="server"> เอกสาร XXXXXXXXXXXXXXXXXXXXXXX </asp:HyperLink></div> 
       <div><strong>สถานะ : ไม่ผ่าน</strong>
           </div>
              </div>
