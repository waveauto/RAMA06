<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Pay-Money.aspx.vb" Inherits="RAMA06.Pay_Money" %>
...
<div class="container">  
    ...
    <hr />
    <div><h1>บันทึกผล การรายงานการชำระเงิน ครั้งที่&nbsp; 1.</h1>
    </div>
      <div class="panel panel-default">
                  <div class="panel-heading"> <strong> บันทึกผล การรายงานการชำระเงิน</strong></div>
                     <div class="panel-body">       
                 <div class="panel-body">       
                     <div><strong>บันทึกการปฏิบัติและ หมายเหตุ</strong> </div>    
                     <div><textarea class="form-control" rows="10"></textarea> </div>    
                     <br />
                     <div><h3>จำนวนเงินที่ชำระ : <asp:TextBox ID="TextBox1" runat="server" Font-Bold="True" Font-Size="20pt">150,000</asp:TextBox>&nbsp;บาท</h3></div>
                     <br />
