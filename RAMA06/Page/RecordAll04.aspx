<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MSPFirst.Master" CodeBehind="RecordAll04.aspx.vb" Inherits="RAMA06.RecordAll04" %>
...
<h1 class="text-center">
                    <a href="#" id="A2" runat="server" class="list-group-item">&nbsp;การขอเงินทุนเพื่อการเดินทางและนำเสนอผลงาน</a></h1>
<br/>
<div class="text-left">  <asp:HyperLink ID="HyperLink1" runat="server" class="btn btn-info btn-lg" NavigateUrl="~/Page/FundingTravelPresent.aspx" Width="200px"><span class="glyphicon glyphicon-edit"></span>ส่งขอเงินทุน...</asp:HyperLink>
