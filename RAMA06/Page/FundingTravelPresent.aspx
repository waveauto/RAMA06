<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MSP01.Master" CodeBehind="FundingTravelPresent.aspx.vb" Inherits="RAMA06.FundingTravelPresent" %>
                    ...
                    <asp:MultiView ID="Multiview1" runat="server" ActiveViewIndex="0">
                        <asp:View ID="viewAllData" runat="server">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">นำเสนอผลงานทางวิชาการใรนลักษณะ :</label>
                                    <div class="col-md-6">
                                        <div class="radio">
                                            <label>
                                                <asp:RadioButton ID="rdbT11" runat="server" GroupName="T1" />Poster Presentation</label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <asp:RadioButton ID="rdbT12" runat="server" GroupName="T1" />Oral Presentation</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="radio">
                                            <label>
                                                <asp:RadioButton ID="rdbt21" runat="server" GroupName="T2" />ระดับชาติ</label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <asp:RadioButton ID="rdbt22" runat="server" GroupName="T2" />ระดับนานาชาติ</label>
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-md-3 control-label">นำเสนอวันที่ :</label>
                                    <div class="col-md-2">
                                        <asp:TextBox ID="txtPresentDate" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-md-3 control-label">ณ ประเทศ :</label>
                                    <div class="col-md-2">
