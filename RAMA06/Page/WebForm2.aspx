<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WebForm2.aspx.vb" Inherits="RAMA06.WebForm2" %>
...
<div> 
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h2 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">ขั้นตอนที่ 2 : เจ้าหน้าที่รับเรื่อง</a>
        </h2>
      </div>
      <div id="collapse1" class="panel-collapse collapse in">
             <div class="panel panel-default">
             <div class="panel-heading"><h4>เจ้าหน้าที่บันทึกสรุปผลการพิจารณารับเรื่อง </h4> </div>
                 <div class="panel-body">       
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h2 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">2.1 : พิจารณาจริยธรรม EC (ถ้ามี)</a>
        </h2>
      </div>
      <div id="collapse2" class="panel-collapse collapse">
        <div class="panel panel-default">
             <div class="panel-heading"><h4>กำหนดกรรมการพิจารณาจริยธรรม (EC)</h4></div>
              ...
              <div class="panel panel-default">
                  <div class="panel-heading">
                      <asp:Button ID="Button6"  class="btn btn-primary" runat="server" Text="เพิ่มกรรมการ" />
                      </div>
                  <div class="panel-body">       
                      <div>
                          <table class="nav-justified">
              ...
              <div class="panel panel-default">
                 ...
                 <div class="panel-body">       
                     ...
                     <br />
                     <div class="text-right"> 
                         <asp:Button ID="Button23" class="btn btn-primary" runat="server" Text="แก้ไข" /> 
              ...
              <div class="panel panel-default">
                 ...
                 <div class="panel-body">       
                     ...
                     <br />
                     <div class="text-right"> 
                         <asp:Button ID="Button25" class="btn btn-primary" runat="server" Text="แก้ไข" /> 
              ...
              <div class="panel panel-default">
                 ...
                 <div class="panel-body">       
                     ...
                     <br />
                     <div class="text-right"> 
                         <asp:Button ID="Button27" class="btn btn-primary" runat="server" Text="แก้ไข" /> 
                         &nbsp;<asp:Button ID="Button35" class="btn btn-primary" runat="server" Text="บันทึก" /> 
                     </div>  
                     <br />  
                     <div class="text-right">ผู้บันทึก : XXXXXXXXX  โทร. XXXXXXX วันที่ 18 ก.ค. 2559 14:45:12 </div>    
                 </div>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h2 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse3">2.2 : พิจารณา ทุนต่างๆ (ถ้ามี)</a>
        </h2>
      </div>
             ...
             <div class="panel-heading"><h4>ขั้นตอนที่ 3 : อนุมัติทำวิจัย</h4> </div>
              <div class="panel-body">       
                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading">
                          <h4 class="panel-title">
                            ...
                            บันทึกสรุป ผลการพิจาณาจริยธรรม (EC)</a>
                          </h4>
                        </div>
                 ...
                 <div class="panel-body">       
                     <div><textarea class="form-control" rows="3"></textarea> </div>    
                     <br />
                     <div class ="text-right"> <asp:FileUpload ID="FileUpload10" runat="server" />    </div>
                     <br />
                 ...
                 <div class="panel-body">       
                     <div><textarea class="form-control" rows="3"></textarea> </div>    
                     <br />
                     <div class ="text-right"> <asp:FileUpload ID="FileUpload11" runat="server" />    </div>
                     <br />
                     <div class="text-right">สถานะ : <asp:DropDownList ID="DropDownList15" runat="server" Width="150px">
                         <asp:ListItem></asp:ListItem>
                         <asp:ListItem>ผ่าน</asp:ListItem>
                         <asp:ListItem>ไม่ผ่าน</asp:ListItem>
                         </asp:DropDownList></div>    
                     <br />
                     <div class="text-right"> 
                         <asp:Button ID="Button36" class="btn btn-primary" runat="server" Text="แก้ไข" /> 
                         &nbsp;<asp:Button ID="Button37" class="btn btn-primary" runat="server" Text="บันทึก" /> 
                     </div>  
                     <br />  
                     <div class="text-right">ผู้บันทึก : XXXXXXXXX  โทร. XXXXXXX วันที่ 18 ก.ค. 2559 14:45:12 </div>    
                 </div>
                    ...
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        ...
                        บันทึกสรุป ผลการอนุมัติการทำโครงการวิจัย</a>
                      </h4>
                    </div>
                 ...
                 <div class="panel-body">       
                     ...
                     <div><textarea class="form-control" rows="3"></textarea> </div>    
                     <br />
                     <div class ="text-right"> <asp:FileUpload ID="FileUpload12" runat="server" />    </div>
                     <br />
                     <div class="text-right">สถานะ : <asp:DropDownList ID="DropDownList16" runat="server" Width="150px">
                         <asp:ListItem></asp:ListItem>
                         <asp:ListItem>ผ่าน</asp:ListItem>
                         <asp:ListItem>ไม่ผ่าน</asp:ListItem>
                         </asp:DropDownList></div>    
                     <br />
                     <div class="text-right"> 
                         <asp:Button ID="Button38" class="btn btn-primary" runat="server" Text="แก้ไข" /> 
                         &nbsp;<asp:Button ID="Button39" class="btn btn-primary" runat="server" Text="บันทึก" /> 
                     </div>  
                     <br />  
                     <div class="text-right">ผู้บันทึก : XXXXXXXXX  โทร. XXXXXXX วันที่ 18 ก.ค. 2559 14:45:12 </div>    
                 </div>
